...
####################################################
def Create_nets(args: BaseConfig):
    generator_AB = Generator(args.input_nc_A,   args.input_nc_B ,args.n_residual_blocks)
    discriminator_B = Discriminator(args.n_D_layers, args.input_nc_B)
    generator_BA = Generator(args.input_nc_B,   args.input_nc_A ,args.n_residual_blocks)
    discriminator_A = Discriminator(args.n_D_layers, args.input_nc_A)

    generator_AB = generator_AB.to(args.device)
    discriminator_B = discriminator_B.to(args.device)
    generator_BA = generator_BA.to(args.device)
    discriminator_A = discriminator_A.to(args.device)
